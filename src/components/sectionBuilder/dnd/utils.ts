...
export const getParents = (
  ...
  id1: string,
  id2: string,
): [GroupField | null, GroupField | null] => {
 ...
 */
export function promoteOrDemoteNode(
  data: SectionField[],
  idToMove: string,
  ...
  if (itemToMove) {
    ...
    if (newParent !== undefined && newParent.type === 'group' && itemToMove.type !== 'group') {
